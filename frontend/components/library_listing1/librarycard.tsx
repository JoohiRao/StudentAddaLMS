...
export default function LibraryCard() {
  ...
  return (
    <div className="flex flex-col gap-4">
      {libraries.map((lib) => (
        <div key={lib.id} className="w-full  p-1 bg-white  md:p-3 lg:p-5 rounded-lg shadow-md">
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-end  md:mt-1  mt-2 w-full">
            ...
            <div className="flex flex-wrap gap-2 md:hidden">
              ...
              <Link href={`/libraries/${lib.id}`} className="w-full">
                <button className="flex w-full items-center justify-center gap-1 bg-black text-white px-4 py-2 rounded-md">
            ...
            <div className="hidden md:flex flex-col items-end gap-2">
              ...
              <Link href={`/libraries/${lib.id}`}>
                <button className="flex items-center justify-center gap-1 bg-black text-white px-4 py-2 rounded-md">
                  Book Now <ArrowRight size={16} />
                </button>
              </Link>
            </div>
