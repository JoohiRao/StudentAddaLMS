  ...
  return (
    <div className="bg-[#ECE3DA]">
      ...
      <div className="main_section relative px-3 sm:px-5 md:px-8 lg:px-[10%] bg-[#ECE3DA] min-h-screen w-full">
        <div className="p-2 py-1 sm:py-6 md:py-8 lg:py-10 mt-2 sm:mt-3 md:mt-4 font-normal text-xl sm:text-2xl md:text-3xl lg:text-[45px] leading-tight sm:leading-tight md:leading-[53.18px] tracking-[0.36px] flex items-center justify-center font-urbanist text-gray-900">
        ...
        <div className="w-full mt-8 sm:mt-10 md:mt-12 lg:mt-14 p-2 sm:p-3 md:p-4 relative rounded-md bg-white mb-10 sm:mb-14 md:mb-16 lg:mb-20">
          ...
          <div className="about_image relative">
            ...
            {/* Responsive Info Box */}
            <div className="w-[80%] sm:w-[75%] md:w-[90%] lg:w-[75%] mx-auto absolute left-0 right-0 top-[75%] sm:top-[90%] z-10 shadow-md rounded-lg text-black bg-white flex">
