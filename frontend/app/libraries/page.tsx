...
export default function AllLibraries() {
  return (
    <div className="bg-[#ECE3DA] ">
      ...
      <div className="main_section relative px-2 lg:px-4 md:px-[5%] bg-[#ECE3DA]  min-h-screen w-full">
        {/* Header */}
        <div className="p-2 py-10 mt-4 text-center text-[16px] sm:text-[24px] md:text-[45px] leading-[1.2] tracking-[0.36px] font-urbanist text-gray-900">
