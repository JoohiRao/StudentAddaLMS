...
export default function What() {
  return (
    <section className="bg-[#ECE3DA] text-center  items-center justify-center min-h-screen w-full overflow-x-hidden py-2 px-2 md:py-10 md:px-5">

        
        <div className="what px-2 sm:px-4 py-8 md:py-16  text-center">
        {/* Heading */}
            ...
            <div className="flex flex-col-reverse lg:flex-col ">
                <p className="text-gray-600 mt-[-10%] lg:mt-[0%] z-100 text-[12px] leading-[16px] sm:text-[15px] sm:leading-[23px] tracking-[-0.04em] font-normal max-w-xs sm:max-w-lg md:max-w-3xl mx-auto mb-1 sm:mb-10 font-['Plus_Jakarta_Sans'] text-left ">
